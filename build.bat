...
set "AROBJS="
for %%o in (ir ir_comptime ir_rules ir_effects ir_purity ir_twins ir_debug_hooks ir_interp ir_optimize ir_pgo ir_profile ir_verify ml_gnn ml_obs ml_opt mtlc_type) do call set "AROBJS=%%AROBJS%% obj\ir\%%o.o"
